...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hp-streak {
    ...
    font-size: .7rem; color: #fbbf24; transition: all .2s;
  }
  ...
  .hp-hero {
    ...
    padding: 36px 36px 32px; border-bottom: 1px solid var(--border);
  }
  .hp-hero::before {
    content: ''; position: absolute; inset: 0;
    ...
    background-size: 36px 36px; animation: hp-grid 24s linear infinite;
